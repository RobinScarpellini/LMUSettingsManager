...
Handles creating, saving, and managing user profiles in AppData/LMUConfigEditor/Profiles.
"""
...
class ProfileManager:
    """Manages user profiles in AppData/LMUConfigEditor."""
    
    def __init__(self):
        self.logger = logging.getLogger(__name__)
        
        # Create profiles directory in proper AppData location
    ...
    def _get_profiles_dir(self) -> Path:
        """
        Get the directory for storing profiles in AppData.
        ...
        return app_data / "LMUConfigEditor" / "Profiles"
